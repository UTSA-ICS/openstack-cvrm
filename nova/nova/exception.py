...
###########My Edit#################
class AttributeExists(NovaException):
    ec2_code = 'InvalidAttribute.Duplicate'
    msg_fmt = _("Attribute '%(attribute_name)s' already exists.")

class AttributeNotFound(NotFound):
    ec2_code = 'InvalidAttribute.NotFound'
    msg_fmt = _("Attribute %(name)s not found")
