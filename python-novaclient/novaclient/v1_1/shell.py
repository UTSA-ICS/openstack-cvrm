...
#from novaclient.v1_1 import attribute
...
@utils.arg(
    ...
    metavar='<name>',
    default=None,
    help=_('Search by attribute name'))
def do_att_create(cs, args):
    print("in attcreate")
    print(cs,args.name)
    result=cs.attribute.create(args)	
    print (result)
@utils.arg(
    '--id',
    dest='id',
    ...
    default=None,
    help=_('Search by attribute name'))
def do_att_delete(cs, args):
    #print("in attcreate")
    #print(cs,args.name)
    result=cs.attribute.delete(args)	

def do_att_list(cs, args):
    """List all attributes."""
    #print ("inlist")
    result = cs.attribute.list()
    #print (result)
    columns = ["Id", "Name"]
    utils.print_list(result, columns)
@utils.arg(
...
@utils.arg(
    ...
    metavar='<value>',
    default=None,
    help=_('Search by attribute value'))
def do_att_value_set(cs, args):
    print("in att-value")
    #print(cs,args.id,args.value)
    result=cs.scope.create(args)	
    #print (result)
def do_att_value_list(cs,args):
    print("in att-value-list")
    #print(cs,args.id,args.value)
    result=cs.scope.list()	
    columns = ["Id","Name", "Value"]
    utils.print_list(result, columns)
    #print (result)
def do_att_value_delete(cs, args):
    #print("in attcreate")
    #print(cs,args.name)
    result=cs.scope.delete(args)
